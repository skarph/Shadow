...
Phew, that was a long one. Why don't we make something now?
</Box>
...
```lua
local root = Component(FixedSizing(320, 240)) -- The root should be a fixed size.
Game.world:addChild(root)
```
